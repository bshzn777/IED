#include <Servo.h> // customed line => 15, 19-23, 80, 84-90, 125
...
// Servo adjustment
#define _DUTY_MAX 2100  // Servo angle: D degree (D = 300)
#define _DUTY_NEU 1550  // Servo angle: 0 degree
#define _DUTY_MIN 1000   // Servo angle: E degree (E = 40)
#define _SERVO_ANGLE_DIFF 100 // Replace with |D - E| degree (40 - (-60))
#define _SERVO_SPEED 1000 // servo speed limit (unit: degree/second) (default = 1000)
...
{
  int x = a_value;
  return 1193 + -10.4 * x + 0.0397 * x * x + -6.92 * 1/10 * 1/10 * 1/10 * 1/10 * 1/10 * x * x * x + 4.39 * 1/10 * 1/10 * 1/10 * 1/10 * 1/10 * 1/10 * 1/10 * 1/10 * x * x * x * x; // Replace this with the equation obtained from nonlinear regression analysis
}
